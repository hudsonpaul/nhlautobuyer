class Card
  ...
  attr_accessor :name, :position, :style, :card_id, :player_type, :overall, :card_db_id, :ea_card, :games_played, :team
  ...
  def self.create_from_carddata(carddata)
    ...
    card.team = Team.where(:ea_id => carddata['teamid']).first if carddata['teamid']

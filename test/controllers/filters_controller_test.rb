...
class FiltersControllerTest < ActionController::TestCase
  ...
  test "should create filter" do
    assert_difference('Filter.count') do
      post :create, filter: { auto_buy_at: @filter.auto_buy_at, name: @filter.name, search_id: @filter.search_id }
    end
  ...
  test "should update filter" do
    patch :update, id: @filter, filter: { auto_buy_at: @filter.auto_buy_at, name: @filter.name, search_id: @filter.search_id }
    assert_redirected_to filter_path(assigns(:filter))
  end
